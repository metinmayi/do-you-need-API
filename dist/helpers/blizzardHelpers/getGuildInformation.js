 ...
 */
function getGuildInformation(realm, guildName, token) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield (0, axios_1.default)(`https://eu.api.blizzard.com/data/wow/guild/${realm}/${guildName.toLowerCase()}?namespace=profile-eu&locale=en_EU&access_token=${token}`);
